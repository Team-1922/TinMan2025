...
public class EndEffector extends SubsystemBase {
  ...
  public EndEffector() {
    ...
    /*
     * //m_ArmMotor.getConfigurator().apply(EndEffectorConstants.
     * closedLoopRampConfigs);
     * m_WristMotor.getConfigurator().apply(EndEffectorConstants.
     * closedLoopRampConfigs);
     * m_leftCollect.getConfigurator().apply(EndEffectorConstants.
     * closedLoopRampConfigs);
     * m_rightCollect.getConfigurator().apply(EndEffectorConstants.
     * closedLoopRampConfigs);
     * 
  ...
  public boolean HasCoral() {
    if (m_LC.getMeasurement() != null && m_LC.getMeasurement().status == LaserCan.LASERCAN_STATUS_VALID_MEASUREMENT) {
       ...
       * } else {
       * System.out.
       * println("Oh no! The target is out of range, or we can't get a reliable measurement!"
       * );
  ...
  public boolean HasStationCoral() {
    ...
    return m_TOF2Measurement >= TOFConstants.TOF2MinDistance &&
