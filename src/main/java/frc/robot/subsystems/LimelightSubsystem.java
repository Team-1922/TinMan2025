...
public class LimelightSubsystem extends SubsystemBase {
  ...
  public double L2AimTargetZDutyCycle() {
    if (!HasTarget())
      return 0;
    double target = MathUtil.clamp(reverseTargetZError() * LimelightConstants.TargetZSpeedMultiplier, -0.8, 0.8);
  ...
  public double L2RobotXDutyCycle() {
    if (!HasTarget())
      return 0;// remove this line, might not see tag because it's too close
  ...
  public double AimTargetZDutyCycle() {
    if (!HasTarget())
      return 0;
    double target = MathUtil.clamp(targetZError() * LimelightConstants.TargetZSpeedMultiplier, -0.8, 0.8);
